...
class Political extends React.Component {
    ...
    componentDidMount() {
        // fetch("http://192.168.0.4:8082/Politicss")    
        fetch("https://jervay.agency/politicss")
            ...
            .then(res => {
                ...
                console.log("this is res.articles: ", articles)
                console.log("this is article1: ", article1)
                let urlPath = res.articles[0].urlToImage.replace('http','');
                console.log('this is the image path', urlPath)
                this.setState({
                    articlesAll: articles,
                    article1: article1.description,
                    content: article1.content
                })
                console.log("This is state.article1: ", this.state.article1);
